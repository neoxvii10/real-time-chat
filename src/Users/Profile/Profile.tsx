...
const Profile: React.FC<ProfileProps> = ({ translateX, setTranslateX }) => {
  ...
  const [translateXForChangePassword, setTranslateXForChangePassword] =
  ...
  const [translateXForChangeEmail, setTranslateXForChangeEmail] =
    useState<CSSProperties>({
      visibility: "hidden",
      opacity: 0,
      transform: "translateX(-480px)",
  ...
  return (
    <>
      <div style={translateX} className="profile-container">
        <div className="profile-header">
          <span
            ...
            onClick={(e) => handleSlideAnimation(e)}
          >
        ...
        <div className="content-profile">
          ...
          <div className="setting">
            <ul>
              <li>
                <div
                  className="list-setting input-change"
                  onClick={(e) => handleSlideChangePassword(e)}
                >
                  <span className="icon">
              ...
              <li>
                <div
                  className="list-setting input-change"
                  onClick={(e) => handleSlideChangeEmail(e)}
                >
                  <span className="icon">
      ...
      <EditProfile
        translateXForEdit={translateXForEdit}
        setTranslateXForEdit={setTranslateXForEdit}
      />
      <ChangePassword
        translateXForChangePassword={translateXForChangePassword}
        setTranslateXForChangePassword={setTranslateXForChangePassword}
      />
      <ChangeEmail
        translateXForChangeEmail={translateXForChangeEmail}
